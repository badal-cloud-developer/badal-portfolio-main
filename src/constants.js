...
export const education = [
  {
    ...
    // grade: "",
    desc: "During my Bachelor's in Computer Engineering at Everest Engineering College (affiliated with Pokhara University), I built a strong foundation in core subjects like Data Structures, Algorithms, Operating Systems, DBMS, and Web Technologies. I actively participated in workshops, coding competitions, and projects that strengthened my practical skills. These experiences helped me develop problem-solving abilities, teamwork, and a passion for programming and continuous learning. ",
    degree: "Bachelor of Engineering  - BE",
  },
  {
    id: 1,
    img: bsaLogo,
    school: "The Times Higher Secondary School",
